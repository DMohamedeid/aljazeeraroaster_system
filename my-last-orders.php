    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-7 col-7">
                <div class="current">
                    <div class="links">
                        <div class="first-links  d-inline">
                            <a href="my-current-orders.php"><?= lang('my_orders') ?></a>
                        </div>
                        <div class="second-links active  d-inline">
...
<div class="no-one">
    <div class="container">
        ...
        <div class="currently text-center">
            ...
            <?php
            $X = 1;
            $result = $con->query("SELECT * FROM `orders` WHERE `client_id`='" . $_COOKIE['client_id'] . "' and  `order_follow` ='3' and  `order_status` ='1'  ORDER BY `order_id` DESC") or die(mysqli_error());
