                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active">View Removes  </li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div class="panel-body">
                                <div class="">
                                    <table class="table table-striped" id="datatable-editable">
                                        ...
                                        <tbody> <?php echo view_removes(); ?> </tbody>
                                    </table>
                                </div>
                            </div>
                        </div>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $('body').on('click', '.on-default', function () {
                    var delete_removes_id = $(this).attr('href');
                    // alert(category);
                    $("#dialogConfirm").click(function () {
                        var dataString = 'delete_removes_id=' + delete_removes_id;
                        $.ajax({
                            type: "POST",
                            url: "functions/removes_function.php",
                            data: dataString,
                            dataType: 'text',
                            cache: false,
