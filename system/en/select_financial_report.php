                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-box">
                                    ...
                                    <form method="get" action="print_selected_financial_report.php" enctype="multipart/form-data" target="_blank" data-parsley-validate>
                                        <div class="form-group">
                                            <label for="select_report"> Choose</label>
                                            <select class="form-control select2me" name="report" id="select_report" required parsley-trigger="change">
                                                <option value='daily'>Day</option>
                                                <option value='week'>Weak</option>
