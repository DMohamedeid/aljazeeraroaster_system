                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active">View  Potatos Type</li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div class="panel-body">
                                <div class="">
                                    <table class="table table-striped" id="datatable-editable">
                                        ...
                                        <tbody> <?php echo view_potatos(); ?> </tbody>
                                    </table>
                                </div>
                            </div>
                        </div>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $('body').on('click', '.on-default', function () {
                    var delete_potatos_id = $(this).attr('href');
                    // alert(category);
                    $("#dialogConfirm").click(function () {
                        var dataString = 'delete_potatos_id=' + delete_potatos_id;
                        $.ajax({
                            type: "POST",
                            url: "functions/potatos_function.php",
                            data: dataString,
                            dataType: 'text',
                            cache: false,
