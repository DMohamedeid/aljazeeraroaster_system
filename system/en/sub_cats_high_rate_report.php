            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="page-title"> Report Of Top Rated Sub Categories</h4>
                                <ol class="breadcrumb">
                                    <li><a href="print_sub_cats_high_rate.php">Report Of Top Rated Sub Categories     </a></li>
                                    <li class="active">Report Of Top Rated Sub Categories     </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-box">
                                    ...
                                    <form method="post" action="print_sub_cats_high_rate.php" enctype="multipart/form-data" target="_blank" data-parsley-validate>
