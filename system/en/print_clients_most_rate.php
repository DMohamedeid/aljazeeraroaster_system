...
<html>
    <head>
        ...
        <title>Most Rated Customers </title>
...
<body>
    <div class="content-page" style="margin-right:15px;    margin-top: 6px;">
        ...
        <div class="content">
            ...
            <h1>  Most Rated customers<?php
                $query = $con->query("SELECT clients.*,  COUNT(`comment_id`) AS ct
FROM sub_category_comments left join clients on clients.client_id=sub_category_comments.client_id 
GROUP BY `sub_category_comments`.`client_id`
