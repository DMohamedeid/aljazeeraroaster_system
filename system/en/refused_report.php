            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="page-title"> Report Refused Orders</h4>
                                <ol class="breadcrumb">
                                    <li><a href="refused_report.php">Report Refused Orders   </a></li>
                                    <li class="active">Report Refused Orders    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-box">
                                    ...
                                    <form method="post" action="print_refused_orders.php" enctype="multipart/form-data" target="_blank" data-parsley-validate>
