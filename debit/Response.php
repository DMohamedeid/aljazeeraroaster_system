...
$Amt=$myObj->getAmt();
if ($Result == "CAPTURED") {
    echo("REDIRECT=https://aljazeeraroastery.com/debit/Success.php?&PaymentId=".$PaymentId);
} else if ($Result == "NOT CAPTURED") {
    echo("REDIRECT=https://aljazeeraroastery.com/debit/Failed.php?Result=" . $Result.'&PaymentId='.$PaymentId.'&TransId='.$TransId.'&Amt='.$Amt);
}
//print_r($_post);
